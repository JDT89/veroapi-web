    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold text-slate-900 mb-3">API Changelog</h1>
          <p className="text-slate-600 text-lg">Stay updated with the latest changes to our API</p>
        </div>
